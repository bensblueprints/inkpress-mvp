...
Don't want to build from source? Get the signed installer, lifetime updates and setup support for a one-time payment at [onetimesuite.com/inkpress](https://onetimesuite.com/inkpress/) — same app, MIT source right here.
